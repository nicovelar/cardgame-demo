...
class QuitarCartaEnTableroUseCaseTest {
    @InjectMocks
    private QuitarCartaEnTableroUseCase useCase;

    @Mock
    private JuegoDomainEventRepository repository;

    @Test
    void quitarCartaEnTablero() {
        //ARRANGE
        var command = new QuitarCartaEnTablero();
        ...
        StepVerifier
                ...
                .expectNextMatches(domainEvent -> {
                    var event = (CartaQuitadaDelTablero) domainEvent;
